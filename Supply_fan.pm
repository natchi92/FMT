...
const int N_CLN  = N;
const int N_RPLC = N;
const double MT_INSP =  30.5*YEAR;  // an inspection  is scheduled every ... days
const double MT_REP  =  30.0*YEAR;  // a repair check is scheduled every ... days
const double MT_OH   = 30.0*YEAR;  // an overhaul    is scheduled every ... days
...
const int COST_REP  = 0;  // costs are in the triggered clean, Hif any
